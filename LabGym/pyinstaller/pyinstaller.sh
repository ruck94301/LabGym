...
case $OSNAME in
    Darwin)
        ...
        #                 title="sunflower icons">Sunflower icons
        #                 created by Freepik - Flaticon</a>

        # (from pyinstaller.org)
        #     (If you do not specify an icon file, PyInstaller supplies
        #     a file icon-windowed.icns with the PyInstaller logo.)
        #
        ...
        #     for more detail, the Apple code signing overview technical
        #     note).
        #
